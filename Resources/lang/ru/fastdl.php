...
return [
    ...
    'create_account'                    => 'Создать новый FastDL',
    ...
    'create_account_success_msg'        => 'FastDL аккаунт успешно создан',
    'create_account_fail_msg'           => 'Ошибка создания FastDL аккаунта',
    ...
    'equal_gameap_port_host_fail_msg'   => 'Указанный хост и порт совпадает с хостом и портом панели. Пожалуйста, укажите другой хост или порт для FastDL.',

    'sync'                              => 'Синхронизировать',
    'd_run_sync'                        => 'Хотите запустить синхронизацию?',
    'sync_started_msg'                  => 'Задание на синхронизацию добавлено в очередь',
];
